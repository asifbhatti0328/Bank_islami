  ...
  return (
    <div className='mt-[4rem]'>
      <div className='flex h-[2rem] pl-2 w-[60%] items-center justify-between'>
        ...
        <h1 className='text-1xl font-bold text-blue-900'>Deposit</h1>
      </div>
      ...
      <div className='p-3'>
        ...
        <p className='pt-2 text-red-500'><b>Note: </b> Send amount (You Want to deposit) to the above mentioned
          ...
          <div className='w-[100%]'>
            <select name="" id="" className='w-[100%] border rounded px-5 h-[4rem] mt-3'>
            <option value="">Select Bank Name</option>
              <option value="">Meezan Bank Limited (MBL)</option>
              <option value="">United Bank Limited (UBL)</option>
              <option value="">MCB Bank (MCB)</option>
              <option value="">Alflha Bank Limited (ABL)</option>
              <option value="">National Bank Of Pakistan (NBP)</option>
              <option value="">Bank Of Punjab (BOP)</option>
              <option value="">Habib Bank Limited (HBL)</option>
              <option value="">Easypaisa</option>
              <option value="">JazzCash</option>
              <option value="">U Paisa</option>
            </select>
          </div>
         ...
         <div className='my-3'>
         <input className='w-[100%] px-5 py-5 border rounded' type="text" placeholder='Account Holder Name'/>
         </div>

         <div className='my-3'>
         <input className='w-[100%] px-5 py-5 border rounded' type="text" placeholder='Account Number'/>
         </div>

         <div className='my-3'>
         <input className='w-[100%] px-5 py-5 border rounded' type="text" placeholder='Amount'/>
         </div>
